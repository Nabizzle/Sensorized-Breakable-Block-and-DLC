...
void setup()
{
  ...
  lis3mdl.setPerformanceMode(LIS3MDL_ULTRAHIGHMODE); //to 
  ...
  lis3mdl.setDataRate(LIS3MDL_DATARATE_1000_HZ); //to increase the rate of data collection, format the argument passed as LIS3MDL_DATARATE_insertDataRate_HZ (decimal places, as in 12.5, are denoted with an underscore)
  ...
  lsm6ds33.setAccelDataRate(LSM6DS_RATE_6_66K_HZ); //to increase the rate of data collection, format the argument of the function as LSM6DS_RATE_insertDataRate_HZ
  ...
  lsm6ds33.setGyroDataRate(LSM6DS_RATE_6_66K_HZ); //to increase the rate of data collection, format the argument of the function as LSM6DS_RATE_insertDataRate_HZ
  ...
  while (counter < 10000) { //The user can change the number of data points that are collected during a trial by changing the number x, where counter < x, in the while loop's conditional statement
